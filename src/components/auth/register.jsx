  ...
  return (
    ...
    >
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-blue-500/5 sm:p-8 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
        ...
        <Form className="flex max-w-7xl mx-auto w-full flex-col gap-5" onSubmit={handleSubmit}>
          {/* Full Name */}
          <TextField
            isRequired
            name="name"
          ...
          >
            ...
            <div className="relative mt-1.5">
              ...
              <Input name="name" className="w-full pl-10" placeholder="Enter your full name" />
            </div>
            <FieldError />
          </TextField>
          ...
          >
            ...
            <div className="relative mt-1.5">
              ...
              <Input name="email" type="email" className="w-full pl-10" placeholder="Enter Your Email Address" />
            </div>
            <FieldError />
          </TextField>
          ...
          <TextField
            ...
            type="url"
            validate={(value) => {
              if (!value) return "Profile image URL is required";
              try {
                new URL(value);
                return null;
              } catch {
          ...
          >
            <Label className="text-sm font-semibold text-slate-700 dark:text-slate-200">Profile Image URL</Label>
            <div className="relative mt-1.5">
              <ImageIcon className="pointer-events-none absolute left-3 top-1/2 z-10 h-4 w-4 -translate-y-1/2 text-slate-400" />
              <Input name="image" type="url" className="w-full pl-10" placeholder="https://example.com/profile.jpg" />
            </div>
            <FieldError />
          </TextField>
