  ...
  return (
    <article className="group rounded-2xl bg-[#eae8e8] p-5 shadow-[0_4px_25px_rgba(15,23,42,0.08)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_35px_rgba(37,99,235,0.15)] dark:border dark:border-slate-800 dark:bg-slate-900! dark:shadow-[0_4px_20px_rgba(0,0,0,0.25)] dark:hover:border-blue-800 dark:hover:shadow-[0_12px_35px_rgba(37,99,235,0.12)]">
      ...
      <div className="flex items-start gap-4">
        {/* Profile Image */}
        <div className="h-12 w-12 shrink-0 overflow-hidden rounded-full border-2 border-white shadow-md ring-1 ring-blue-100 transition-all duration-300 group-hover:ring-blue-300 dark:border-slate-800 dark:ring-blue-500/20 dark:group-hover:ring-blue-500/40">
          <Image
            width={300}
            height={300}
      ...
      {/* ================= COMMENT ================= */}
      <div className="relative mt-5 overflow-hidden rounded-xl bg-[#e5e1e1] p-4 shadow-inner transition-all duration-300 dark:border dark:border-slate-800 dark:bg-slate-800/80 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 dark:group-hover:border-blue-900">
        {/* Decorative Glow */}
      ...
      <div className="mt-4 flex flex-col gap-3 pt-4 dark:border-t dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
        {/* Idea Information */}
        <div className="flex justify-center md:justify-start min-w-0 items-center gap-2">
        ...
        {/* Edit + Delete Buttons */}
        <div className="mt-2 flex justify-center md:justify-start shrink-0 items-center gap-2">
          {/* Edit */}
          <button
            type="button"
