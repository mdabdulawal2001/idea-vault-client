      ...
      <section className="relative overflow-hidden border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            >
              <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3.5 py-1.5 text-xs font-bold text-blue-600 dark:bg-blue-500/10 dark:text-cyan-400">
            ...
            >
              <div className="group relative">
                ...
                <div className="relative h-72 overflow-hidden rounded-3xl shadow-xl shadow-blue-500/10 sm:h-80 lg:h-96">
                  ...
                  <div className="absolute right-5 top-5 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-blue-600 opacity-0 shadow-sm backdrop-blur-md transition-all group-hover:opacity-100 dark:bg-slate-900/90 dark:text-cyan-400">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-7 lg:col-span-2">
            ...
            <ContentSection
              ...
              title={
                <>
                  Problem <Accent>Statement</Accent>
                </>
              }
              box
            >
            ...
            <ContentSection
              ...
              title={
                <>
                  Proposed <Accent>Solution</Accent>
                </>
              }
              box
            >
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {idea.tags?.map((tag, index) => (
                  <motion.span
                    key={`${tag}-${index}`}
                    whileHover={{ y: -2 }}
                    className="rounded-lg bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-600 transition-colors hover:bg-blue-100 dark:bg-blue-500/10 dark:text-cyan-400 dark:hover:bg-blue-500/20"
                  >
                    #{tag}
                  </motion.span>
                ))}
          ...
          <aside className="space-y-6">
            ...
            <SidebarCard
              title={
                <>
                  About the <Accent>Creator</Accent>
                </>
              }
            >
            ...
            <SidebarCard title="Timeline">
              ...
              <TimelineItem
                label="Last Updated"
                date={formatDate(idea.updatedAt)}
              />
            </SidebarCard>

            <Link
              href="/ideas"
              className="group flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-3 text-sm font-bold text-white transition-all hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/20 dark:bg-blue-500 dark:hover:bg-blue-600"
            >
              Explore More Ideas
...
const ContentSection = ({ icon, title, children, box = false }) => (
  <motion.section
    initial={{ opacity: 0, y: 25 }}
    whileInView={{ opacity: 1, y: 0 }}
    viewport={{ once: true, amount: 0.15 }}
    transition={{ duration: 0.5 }}
    className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md sm:p-8 dark:border-slate-800 dark:bg-slate-900"
  >
    <div className="flex items-center gap-3">
    ...
    <div
      className={
        box
          ? "mt-5 rounded-xl border border-blue-100 bg-blue-50/70 p-5 text-sm leading-7 text-slate-700 dark:border-blue-900/30 dark:bg-blue-500/5 dark:text-slate-300"
          : "mt-5"
      }
    >
      {children}
...
const SidebarCard = ({ title, children }) => (
  <motion.section
    ...
    viewport={{ once: true, amount: 0.15 }}
    transition={{ duration: 0.5 }}
    className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/5 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-blue-900"
  >
    <h2 className="text-lg font-bold text-slate-900 dark:text-white">
      {title}
    </h2>
...
const InfoItem = ({ icon, label, value }) => (
  <motion.div
    whileHover={{ x: 3 }}
    className="flex gap-3 rounded-xl bg-slate-50 p-4 transition-colors hover:bg-blue-50/60 dark:bg-slate-800/50 dark:hover:bg-blue-500/5"
  >
