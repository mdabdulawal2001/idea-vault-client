  ...
  <div className="absolute bottom-3.5 left-4 flex items-center gap-2">
    {/* ... */}
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <Link
          href={`/ideas/${idea._id}`}
          className="mt-4 flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-xs font-bold text-white transition-all duration-300 hover:bg-blue-700 hover:shadow-md hover:shadow-blue-500/20 dark:bg-blue-500 dark:hover:bg-blue-600"
        >
          View Details
