...
const AddIdeaForm = () => {
  ...
  return (
    <section className="min-h-screen bg-linear-to-br from-default-50 via-background to-primary/5 px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-14 dark:from-background dark:via-background dark:to-primary/5">
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mb-8 sm:mb-10 lg:mb-12">
          ...
          <div className="mb-4 flex flex-col md:flex-row items-center justify-center md:justify-start md:gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-600/10 text-blue-600 shadow-sm ring-1 ring-blue-600/10 sm:h-11 sm:w-11 dark:bg-blue-500/15 dark:text-blue-400 dark:ring-blue-500/20">
              <Lightbulb size={21} />
            </div>

            <div className="flex flex-col justify-center items-center md:items-start">
              <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">IdeaVault</p>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl lg:text-4xl text-center md:text-left">
            Add a New Idea
          </h1>
        ...
        <div className="overflow-hidden rounded-2xl border border-default-200/80 bg-content1 shadow-xl shadow-default-200/20 dark:border-default-100/10 dark:shadow-black/20">
          <form onSubmit={handleSubmit}>
                ...
                <FormField label="Category" required>
                  <div className="relative">
                    <select
                      ...
                      required
                      className="h-12 w-full appearance-none rounded-xl border border-default-300/80 bg-background/60 px-4 pr-11 text-sm text-foreground outline-none transition-all duration-200 hover:border-blue-500/50 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 dark:border-default-100/15 dark:bg-default-50/5 dark:hover:border-blue-400/50"
                    >
                      <option
                        value=""
            ...
            <div className="border-t border-default-200/80 bg-default-50/30 p-5 sm:p-7 lg:p-9 dark:border-default-100/10 dark:bg-default-50/5">
              {/* Section Header */}
            ...
            <div className="border-t border-default-200/80 bg-default-100/30 px-5 py-6 sm:px-7 lg:px-9 dark:border-default-100/10 dark:bg-default-50/5">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex w-full flex-col-reverse gap-3 sm:w-auto sm:flex-row">
                  ...
                  <button
                    type="button"
                    onClick={handleReset}
                    className="group inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-default-300/80 bg-background px-5 text-sm font-semibold text-foreground cursor-pointer transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-blue-500/50 hover:bg-blue-500/5 hover:text-blue-600 hover:shadow-md active:translate-y-0 dark:border-default-100/15 dark:bg-default-50/5 dark:hover:border-blue-400/50 dark:hover:text-blue-400 sm:w-auto"
                  >
                    <RotateCcw
                      size={16}
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        required={required}
        min={min}
        className={`h-12 w-full rounded-xl border border-default-300/80 bg-background/60 text-sm text-foreground outline-none transition-all duration-200 placeholder:text-default-400 hover:border-blue-500/50 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 dark:border-default-100/15 dark:bg-default-50/5 dark:hover:border-blue-400/50 ${
...
const TextareaField = ({
  ...
  return (
    <textarea
      ...
      rows={rows}
      required={required}
      className="w-full resize-y rounded-xl border border-default-300/80 bg-background/60 px-4 py-3.5 text-sm leading-6 text-foreground outline-none transition-all duration-200 placeholder:text-default-400 hover:border-blue-500/50 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 dark:border-default-100/15 dark:bg-default-50/5 dark:hover:border-blue-400/50"
    />
  );
};
